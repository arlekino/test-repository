...
```
cd existing_repo
git remote add origin https://gitlab.com/arlekino/test-repository.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/arlekino/test-repository/-/settings/integrations)
